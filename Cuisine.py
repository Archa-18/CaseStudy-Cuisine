...
cv=CountVectorizer()
x= cv.fit_transform(data['all_ind'])
...
#RandomForest 0.7531215955752953
#NaiveBayes 0.730160060336881
#DecisionTreeClassifier 0.6307718092684154
#svm 0.7792675773066287
